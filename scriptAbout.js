...
// 1. Research and Survey Solutions
// 2. Impact and Evaluation Assessment
// 3. Plan, Policy, and Project Development
// 4. Technical Services
// 5. Context analysis
// 6. Impact Assessment of implemented Programs on Security
// `;
...
let firmProfileIndex = 0;
let ourServicesIndex = 0;
let companyCapabilitiesIndex = 0;

const firmProfileElement = document.getElementById("firm-profile-answer");
//const ourServicesElement = document.getElementById("our-services-answer");
const companyCapabilitiesElement = document.getElementById("company-capabilities-answer");

console.log(firmProfileElement); // Debugging log
...
window.onload = function () {
  typeText(firmProfileElement, firmProfileText, firmProfileIndex);
  //setTimeout(() => typeText(ourServicesElement, ourServicesText, ourServicesIndex), 1000); // Delay for better presentation
